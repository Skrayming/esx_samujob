Locales['fr'] = {
  ...
  ['bullet2_wear'] = 'Tenue Manche Longue',
  ...
  ['actions_prompt'] = 'press ~INPUT_CONTEXT~ access the ~y~Samu Actions~s~.',
  ...
  ['ems_menu_title'] = 'samu - Interactions Citoyen',
