...
Config.SamuDatabaseName = 'samu'-- set the exact name from your jobs database for police
...
Config.CarZones = {
	...
	SamuCarGarage = {
		...
		Pos = {
			...
			{x = -457.73400878906,  y = -331.38201904296, z = 34.363655090332},
		}
...
Config.HeliZones = {
	...
	SamuHeliGarage = {
		...
		Pos = {
			...
			{x =  -475.62448120118,  y = 5988.1733398438, z = 50.3367061615},  
...
-- Samu Heli Garage Blip Settings:
...
-- Samu Boat Garage Blip Settings:
...
-- Samu Car Garage Marker Settings:

Config.SamuCarMarker = 27 												-- marker type

Config.SamuCarMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 			-- rgba color of the marker

Config.SamuCarMarkerScale = { x = 1.5, y = 1.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis

Config.CarDraw3DText = "[E] Pour Ouvrir Le Garage"			-- set your desired text here



-- Samu Heli Garage Marker Settings:

Config.SamuHeliMarker = 27 												-- marker type

Config.SamuHeliMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker

Config.SamuHeliMarkerScale = { x = 5.5, y = 5.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis

Config.HeliDraw3DText = "[E] Pour Ouvrir Le Garage"		-- set your desired text here



-- Samu Boat Garage Marker Settings:

Config.SamuBoatMarker = 27 												-- marker type

Config.SamuBoatMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker

Config.SamuBoatMarkerScale = { x = 3.0, y = 3.0, z = 1.0 }  				-- the scale for the marker on the x, y and z axis

Config.BoatDraw3DText = "[E] Pour Ouvrir Le Garage"		-- set your desired text here



-- Samu Extra Garage Marker Settings:

Config.SamuExtraMarker = 27 												-- marker type

Config.SamuExtraMarkerColor = { r = 50, g = 50, b = 204, a = 100 } 		-- rgba color of the marker

Config.SamuExtraMarkerScale = { x = 2.5, y = 2.5, z = 1.0 }  				-- the scale for the marker on the x, y and z axis

Config.ExtraDraw3DText = "Press ~g~[E]~s~ for ~y~Samu Extra Menu~s~"		-- set your desired text here
...
Config.SamuVehicles = {
		...
		{ model = '', label = '-----Voitures-----'},
                ...
                { model = 'vsav752', label = 'Vsav Samu'},

                { model = '3008samu', label = '3008 Samu'},

                { model = 'moonbeam', label = 'Cammionette Samu'},

                { model = 'samu33', label = 'Ford Samu'},
...
Config.SamuHelicopters = {

	{ model = 'supervolito2', label = 'Helicoptere', livery = 0, price = 0 },
        { model = 'swift', label = 'Helicoptere (camera)', livery = 0, price = 0 }
...
Config.SamuBoats = {
	...
	{ model = 'predator', label = 'Samu Predator', livery = 0, price = 0 },
...
Config.TitleSamuGarage = "Samu Garage"

Config.TitleSamuExtra = "Extra"

Config.TitleSamuLivery = "Livery"
...
Config.CarOutFromPolGar = "Tu as pris un ~b~Véhicule~s~ du ~y~Garage~s~!"

Config.HeliOutFromPolGar = "Tu as pris un ~b~Hélicopter~s~ du ~y~Garage~s~!"

Config.BoatOutFromPolGar = "You took out a ~b~Boat~s~ from ~y~Samu Boat Garage~s~!"
...
Config.ExtraZones = {
	...
	ExtraPositions = {
		...
		Pos = {
			...
			{x = -446.85711669922,  y = 5994.419921875, z = 31.3405418396},
